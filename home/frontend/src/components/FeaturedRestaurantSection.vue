...
export default {
   ...
   data() {
    ...
    computed: {
        items() {
            return this.$store.state.restaurantArr.slice(this.this_item, this.this_item + this.showed_items);
        },
        showPrev() {
            return this.this_item > 0;
        },
        showNext() {
            return this.$store.state.restaurantArr.length > this.this_item + this.showed_items;
        },
        imgWidth() {
            return '235px';
        },
